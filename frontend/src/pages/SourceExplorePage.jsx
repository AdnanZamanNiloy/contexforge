...
export default function SourceExplorePage() {
      ...
      <section className="panel source-details-panel">
        ...
        <dl className="source-detail-grid">
          <div className="source-detail-tile">
            <dt>Type</dt>
            <dd>
              <span className={`source-type-pill is-${source.type}`}>
  ...
  const mainContent = (() => {
    switch (tab) {
      ...
      case 'overview':
      default:
        return <OverviewTab source={source} onOpenChat={() => setTab('chat')} />
    }
  })()
    ...
    <div className="overview-grid">
      <section className="panel overview-panel">
        ...
        <p className="overview-blurb">
          This {source.type} source has been indexed into your ContextForge knowledge base. Ask
          questions about it, or explore it visually with a mind map.
          {source.type === 'github'
            ? ' Use Repository Intelligence to understand its architecture.'
            : ''}
        </p>
      </section>
      <section className="panel overview-panel">
