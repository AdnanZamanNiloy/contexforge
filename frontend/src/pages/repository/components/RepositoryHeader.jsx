  ...
  return (
    <header className="repo-header">
      <div className="repo-context">
        ...
        <span className={`repo-visibility is-${visibility}`}>{visibility === 'private' ? 'Private' : 'Public'}</span>
      ...
      <div className="repo-header-right">
        <span className="repo-meta">
          <span><b>{files.toLocaleString()}</b> files</span>
          <span className="repo-meta-sep">·</span>
          <span><b>{commits.toLocaleString()}</b> commits</span>
          <span className="repo-meta-sep">·</span>
