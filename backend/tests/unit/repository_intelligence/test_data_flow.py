...
def _nodes_and_edges():
    nodes = [
        {"id": "repo", "label": "repo", "kind": "repo", "path": "/",
         "deps": 0, "dependents": 0},
        {"id": "app/routes/query.py", "label": "query.py", "kind": "file",
         "path": "app/routes/query.py", "deps": 0, "dependents": 0},
        {"id": "app/services/query_service.py", "label": "query_service.py",
         "kind": "file", "path": "app/services/query_service.py",
         "deps": 0, "dependents": 1},
        {"id": "core/storage.py", "label": "storage.py", "kind": "file",
         "path": "core/storage.py", "deps": 0, "dependents": 0},
        {"id": "core/llm.py", "label": "llm.py", "kind": "file",
         "path": "core/llm.py", "deps": 0, "dependents": 0},
    ]
    edges = [
        {"source": "app/routes/query.py", "target": "app/services/query_service.py",
         "kind": "imports", "relationship_source": "ast", "confidence": 1.0},
        {"source": "app/services/query_service.py", "target": "core/storage.py",
         "kind": "imports", "relationship_source": "ast", "confidence": 1.0},
        {"source": "app/services/query_service.py", "target": "core/llm.py",
         "kind": "calls", "relationship_source": "ast", "confidence": 0.7},
    ]
    return nodes, edges
...
def test_detects_directional_flow_from_route_entry():
    ...
    assert {"app/routes/query.py", "app/services/query_service.py",
            "core/storage.py", "core/llm.py"} <= ids
